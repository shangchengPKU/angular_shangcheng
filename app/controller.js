function mainctrl ($scope){
	...
	$scope.comments=[
			{commTarget:'小鱼儿',userImg:"images/a9.jpg",userName:"尚诚",userComment:'煎饼果子很好吃',time:''},
			{commTarget:'请叫我大帅柯',userImg:"images/a8.jpg",userName:"刚刚",userComment:'我只是从这里路过......',time:''}
	]
	$scope.addComment=function(){
		var comArr=[];
		comArr.userImg="images/a5.jpg";
		comArr.commTarget="请叫我大帅柯";
		comArr.userName="shangcheng";
